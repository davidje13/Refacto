declare module 'prop-types' {
  /* eslint-disable max-len */ // external source
  /* eslint-disable @typescript-eslint/no-empty-interface, @typescript-eslint/member-ordering, @typescript-eslint/array-type */

  // https://github.com/DefinitelyTyped/DefinitelyTyped/pull/38015
  ...
  /* eslint-enable @typescript-eslint/no-empty-interface, @typescript-eslint/member-ordering, @typescript-eslint/array-type */
