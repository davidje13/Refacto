...
The screenshots can be generated by:
...
3. Use the developer tools' "Capture Screenshot" action to take screenshots of
   elements with transparent backgrounds.
4. Crop the screenshot to the correct size, and optimise the file for a smaller
   size.

The screenshots are defined in `frontend/src/gallery`.
